// teachings-list.js — 相談者一覧表示専用JavaScript
(() => {
  'use strict';
  ...
  function log(...args) {
    if (DEBUG) console.log('[TeachingsList]', ...args);
  }

  function error(...args) {
    console.error('[TeachingsList ERROR]', ...args);
  }
  ...
  // メイン初期化関数
  async function init() {
    log('Initializing teachings list page');
